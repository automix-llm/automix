/* PrismJS 1.29.0
https://prismjs.com/download.html#themes=prism-okaidia&languages=markup+css+clike+javascript+css-extras+diff+python&plugins=line-highlight+line-numbers+custom-class+show-language+autoloader+toolbar+copy-to-clipboard+diff-highlight */
			...
			ranges.forEach(function (currentRange) {
				...
				if (hasLineNumbers && Prism.plugins.lineNumbers) {
					...
					mutateActions.push(function () {
						...
						if (start == 3) {
							line.style.backgroundImage = 'linear-gradient(to right, hsla(0, 88%, 54%, 0.3), hsla(0, 88%, 54%, 0.0))';
							line.setAttribute('data-end', String(3));
						}
